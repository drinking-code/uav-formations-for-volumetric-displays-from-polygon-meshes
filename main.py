...
# mesh = np_stl.Mesh.from_file('sword_full.stl')
# mesh = np_stl.Mesh.from_file('sword_full_angle.stl')
# mesh = np_stl.Mesh.from_file('monkey.stl')
mesh = np_stl.Mesh.from_file('cube.stl')
# mesh = np_stl.Mesh.from_file('cylinder.stl')
mesh = Mesh(mesh)
...
print(f'Maximum smallest UAV distance / Average smallest UAV distance / MIN_DISTANCE: {maximum_smallest_distance} / {avg_distance} / {MIN_DISTANCE}')
